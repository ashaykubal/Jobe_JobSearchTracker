...
const SearchCard: React.FC<SearchCardProps> = ({
  ...
  return (
    <div className={`bg-dark-card/70 backdrop-blur-sm rounded-lg shadow-glow-card border border-dark-border hover:shadow-glow-card-hover hover:border-primary/20 transition-all duration-300 ${(isWorkStyleDropdownOpen || isLocationDropdownOpen) ? 'relative z-[999] transform translate-z-0' : ''}`}>
      {/* Main Card Content */}
